...
public class Tests {
    ...
    public void testForExpressions() throws Exception {
        ...
        assert (e4.assign("T", new Nand(new Var("x"), new Var("y"))).toString()
                .equals("((x ^ y) | ~((z & T)))"));
        assert (e4.assign("z", new Nand(new Var("x"), new Var("y"))).toString()
                .equals("((x ^ y) | ~(((x A y) & T)))"));
        assert (e4.assign("z", new Nand(new Var("x"), new Var("y"))).simplify()
                .toString().equals("((x ^ y) | ~((x A y)))"));
